...
public enum Role {
    ...
    // MANAGER and TRAVEL_AGENT share CRM_FULL today; split by changing this mapping alone.
    public List<SimpleGrantedAuthority> authorities() {
        return switch (this) {
            ...
            case MANAGER, TRAVEL_AGENT -> List.of(new SimpleGrantedAuthority("CRM_FULL"));
        };
    }
}