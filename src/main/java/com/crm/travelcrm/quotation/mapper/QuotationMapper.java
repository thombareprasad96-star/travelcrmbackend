...
public class QuotationMapper {
        ...
        if (h.getHotels() != null) {
            for (QuotationRequestDto.HotelItem hi : h.getHotels()) {
                q.addHotel(QuotationHotel.builder()
                        .hotelMasterPublicId(hi.getHotelMasterPublicId())
                        .roomTypeMasterPublicId(hi.getRoomTypeMasterPublicId())
                        .mealPlanMasterPublicId(hi.getMealPlanMasterPublicId())
                        .platformHotelPublicId(hi.getPlatformHotelPublicId())
                        .platformRoomPublicId(hi.getPlatformRoomPublicId())
                        .platformMealPlanPublicId(hi.getPlatformMealPlanPublicId())
                        .name(hi.getName())
                        .city(hi.getCity())
                        ...
                        .bedType(hi.getBedType())
                        .occupancy(hi.getOccupancy())
                        .adults(hi.getAdults())
                        .children(hi.getChildren())
                        .infants(hi.getInfants())
                        .extraBeds(hi.getExtraBeds())
                        .childAges(hi.getChildAges() == null
                                ? new java.util.ArrayList<>() : new java.util.ArrayList<>(hi.getChildAges()))
                        .rateSource(hi.getRateSource())
    ...
    private QuotationResponseDto.HotelItem toHotel(QuotationHotel h) {
        return QuotationResponseDto.HotelItem.builder()
                ...
                .bedType(h.getBedType())
                .occupancy(h.getOccupancy())
                .adults(h.getAdults())
                .children(h.getChildren())
                .infants(h.getInfants())
                .extraBeds(h.getExtraBeds())
                .childAges(h.getChildAges() == null ? java.util.List.of() : h.getChildAges())
